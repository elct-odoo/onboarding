...
## DEMOS
- [DroneZone Demo]([./dropzone-demo/database-config.md](https://github.com/elct-odoo/onboarding/blob/main/dronezone-demo/database-config.md)): This is a database configuration for a client named DroneZone 2.0.
